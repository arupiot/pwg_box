// Venice Biennale 2021 - Play with(out) Grounds Box
// Francesco Anselmo
// francesco.anselmo@gmail.com

/* [Description] */
//preset description (any text):
preset_descr = "Venice Biennale 2021 Play with(out) Grounds Box";
//preset version:
preset_ver = "1.0";
...
h1v = [2, 2, 0, 0, 5, 1, 1, 0, 1];
h2v = [2, 2, 58/2, 23/2, 3, 2, 2, 0, 4];
h3v = [2, 2, -58/2, -23/2, 3, 2, 2, 0, 4];
h4v = [2, 2, -58/2, 23/2, 3, 2, 2, 0, 4];
h5v = [2, 2, 58/2, -23/2, 3, 2, 2, 0, 4];
h6v = [2, 1, 0, 0, 36, 0, 0, 0, 0];
h7v = [2, 1, 32/2, 32/2, 3, 0, 0, 0, 0];
h8v = [2, 1, -32/2, -32/2, 3, 0, 0, 0, 0];
h9v = [2, 1, 32/2, -32/2, 3, 0, 0, 0, 0];
h10v = [2, 1, -32/2, 32/2, 3, 0, 0, 0, 0];
h11v = [0, 5, 0, 4+7/2, 18, 7,0, 0, 0];
h12v = [0, 3, -20, 4+7/2, 18, 12, 0, 0, 0];
h13v = [0, 3, 15, 4+7/2, 30, 10, 0, 0, 0];
h14v = [1, 3, 15+27/4, 4+7/2, 27/1.5, 10, 0, 0, 0];
